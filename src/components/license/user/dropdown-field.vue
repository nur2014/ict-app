...
export default {
    ...
    created () {
      if (this.data.dropdownData.component_id === '0') {
        ...
        const commonStore = this.data.dropdownData.component_id === '1' ? this.$store.state.ExternalUserIrrigation.commonObj : this.$store.state.ExternalLrcpn.lrcpnObj
    ...
    methods: {
      ...
      changeDrp (event) {
        ...
        if (this.data.dropdownData.component_id === '1') {
          const ChildDrpList = this.$store.state.ExternalUserIrrigation.commonObj[this.drpChangeData.dropdownData.dropdown_name]
          ...
          const ChildDrpList = this.$store.state.ExternalLrcpn.lrcpnObj[this.drpChangeData.dropdownData.dropdown_name]
          const parent = ChildDrpList[0].parent
          this.drpChangeData.dropdownData.dropdown_options = ChildDrpList.filter(item => item[parent] === event)
        }
